...
Ryan = Spot.create(host_id: user1.id,
            ...
            city: 'Boston',
            address: 'Boston1',
            img_url:'https://images.pexels.com/photos/2317972/pexels-photo-2317972.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260',
            lat: 42.369797,
            lng: -71.084181,
            rate: 5,
            num_guests: 1,   
...
Ron = Spot.create(host_id: user1.id,
            ...
            img_url:'https://images.pexels.com/photos/271795/pexels-photo-271795.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260',
            lat: 29.4564343,
            lng: -98.5052856,
            rate: 2,
            num_guests: 2,   
...
spot6 = Spot.create(host_id: user1.id,
            ...
            img_url:'https://images.pexels.com/photos/2635038/pexels-photo-2635038.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260',
            lat: 30.266207,
            lng: -97.7503212,
            rate: 2,
            num_guests: 2,   
...
spot1 = Spot.create(host_id: user1.id,
            ...
            img_url:'https://images.pexels.com/photos/706137/pexels-photo-706137.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260',
            lat: 40.6980535,
            lng: -73.9373694,
            rate: 1,
            num_guests: 2,   
...
spot5 = Spot.create(host_id: user1.id,
            ...
            img_url:'https://images.pexels.com/photos/279607/pexels-photo-279607.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260',
            lat: 30.266207,
            lng: -97.7503212,
            rate: 2,
            num_guests: 2,   
...
spot7 = Spot.create(host_id: user1.id,
            ...
            img_url:'https://images.pexels.com/photos/2082087/pexels-photo-2082087.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260',
            lat: 30.266207,
            lng: -97.7503212,
            rate: 4,
            num_guests: 4,   
...
spot9 = Spot.create(host_id: user1.id,
            ...
            img_url:'https://images.pexels.com/photos/3457299/pexels-photo-3457299.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260',
            lat: 41.8165421,
            lng: -87.6252152,
            rate: 1,
            num_guests: 2,   
...
spot11 = Spot.create(host_id: user1.id,
            ...
            img_url:'https://images.pexels.com/photos/2440471/pexels-photo-2440471.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260',
            lat: 30.3076859,
            lng: -97.89383,
            rate: 5,
            num_guests: 4,   
