...
Justin = Spot.create(host_id: user1.id,
            ...
            city: 'New York',
            address: 'New York4',
            img_url:'http://lifepointchurch.info/wp-content/uploads/2018/10/how-to-make-your-bedroom-darker-how-to-make-your-bedroom-cozy-contemporary-bedroom-and-arm-chair-chrome-crown-molding-dark-stain-fire-surround-fireplace-french-doors-gray-lamp-master-suite.jpg',
            lat: 40.8070779,
            lng: -73.9515882,
            rate: 3,
            num_guests: 1,   
...
AA = Spot.create(host_id: user1.id,
            ...
            city: 'New York',
            address: 'New York5',
            img_url:'https://media.licdn.com/dms/image/C4D22AQG_i2cPSnGSNA/feedshare-shrink_8192/0?e=1554516000&v=beta&t=mA6ggT7XHecckVjih8RZ2pXHsQJj0qguQVbF66D8FgA',
            lat: 40.7513597,
            lng: -73.986111,
            rate: 200,
            num_guests: 40,   
